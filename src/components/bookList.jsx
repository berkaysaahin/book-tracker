...
export default function BookList() {
  ...
  return (
    <div className="w-[40rem] h-min border-4 border-dark-text bg-secondary rounded-lg">
      <div className="h-min w-full border-b-4 flex justify-between items-center px-4 py-2 text-2xl font-extrabold text-dark-text">
        Books You've read
         <img
      ...
      <div className="w-full grid grid-cols-1 divide-y-4 divide-dark-text text-dark-text ">
        {books.map((book, i) => (
          ...
          >
            <p className="font-bold text-xl">{book}</p>
            <img
